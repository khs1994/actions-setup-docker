...
async function run() {
  ...
  if (platform === 'darwin') {
    ...
    core.startGroup('start docker setp1');
    ...
    core.endGroup();
    core.startGroup('start docker setp2');
    ...
    await exec.exec('sudo', [
      ...
      '-cx',
      `
while ! /Applications/Docker.app/Contents/Resources/bin/docker info &>/dev/null; do sleep 1; /Applications/Docker.app/Contents/Resources/bin/docker info;done
